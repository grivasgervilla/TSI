(define (problem ej4)
  ...
  (:objects
    zapatilla1 oscar1 oscar2 oscar3 bikini1 rosa1 algoritmo1 oro1 manzana4 - objeto
    Mononoke - personaje
    Gauss - personaje
    Layton - personaje
    Escarlata - personaje
  ...
  (:INIT
    ...
    (en rosa1 Z2) (en oro1 Z4) (en algoritmo1 Z8) (en manzana4 Z16)

    (zapatilla zapatilla1) (bikini bikini1)
    (oscar oscar1) (oscar oscar2) (oscar oscar3)
    (rosa rosa1) (oro oro1) (algoritmo algoritmo1) (manzana manzana4)
